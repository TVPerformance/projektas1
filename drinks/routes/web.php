...
|
*/
Route::get('admin/types/booking', [B::class, 'index'])->name('booking');
Route::post('admin/types/booking', [B::class, 'store'])->name('tobook');
Route::get('admin/types/booking/show', [B::class, 'show'])->name('show');
